...
public class SPUtils {
    ...
    public static final String KEY_THEME = "refus.theme";
    public static final String KEY_LANGUAGE = "refus.language";
    public static final String KEY_SEARCH_HISTORY = "refus.history";
